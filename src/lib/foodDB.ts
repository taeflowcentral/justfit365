...
const alimentosDB: AlimentoBase[] = [
  ...
  { nombre: 'Boniato asado', porcionDefault: '200g', cal: 180, prot: 2, carb: 42, grasa: 0, tags: 'batata camote tuberculo' },
  ...
  { nombre: 'Ensalada de rucula, queso azul y pera', porcionDefault: '1 plato (250g)', cal: 290, prot: 10, carb: 18, grasa: 19, unidad: 'plato', tags: 'ensalada gourmet roquefort' },
  ...
  { nombre: 'Flan mixto (dulce de leche y crema)', porcionDefault: '1 porcion', cal: 340, prot: 7, carb: 42, grasa: 16, unidad: 'porcion', tags: 'snack permitido postre dulce' },
  { nombre: 'Flan con stevia (sin azucar)', porcionDefault: '1 porcion', cal: 110, prot: 7, carb: 7, grasa: 6, unidad: 'porcion', tags: 'snack permitido postre dulce sin azucar light' },
  ...
  { nombre: 'Mostaza Clasico (hamburguesa)', porcionDefault: '1 unidad', cal: 510, prot: 25, carb: 40, grasa: 27, unidad: 'unidad', tags: 'mostaza comida rapida hamburguesa cadena argentina' },
  { nombre: 'Mostaza Doble (hamburguesa)', porcionDefault: '1 unidad', cal: 720, prot: 42, carb: 42, grasa: 42, unidad: 'unidad', tags: 'mostaza comida rapida hamburguesa cadena argentina' },
  ...
  { nombre: 'Helado de crema (1 bocha)', porcionDefault: '1 bocha', cal: 145, prot: 2, carb: 15, grasa: 9, unidad: 'bocha', tags: 'snack permitido postre dulce vainilla americana' },
  { nombre: 'Helado de chocolate (1 bocha)', porcionDefault: '1 bocha', cal: 150, prot: 3, carb: 18, grasa: 8, unidad: 'bocha', tags: 'snack permitido postre dulce' },
  { nombre: 'Helado de dulce de leche (1 bocha)', porcionDefault: '1 bocha', cal: 155, prot: 3, carb: 19, grasa: 8, unidad: 'bocha', tags: 'snack permitido postre dulce' },
  ...
  { nombre: 'Big Mac (McDonalds)', porcionDefault: '1 unidad', cal: 563, prot: 26, carb: 45, grasa: 33, unidad: 'unidad', tags: 'usa mcdonalds comida rapida hamburguesa cadena' },
  { nombre: 'McDonalds doble carne (Cuarto Doble)', porcionDefault: '1 unidad', cal: 740, prot: 48, carb: 43, grasa: 42, unidad: 'unidad', tags: 'usa mcdonalds comida rapida hamburguesa cadena cuarto de libra' },
  { nombre: 'Cuarto de Libra con queso (McDonalds)', porcionDefault: '1 unidad', cal: 520, prot: 30, carb: 42, grasa: 26, unidad: 'unidad', tags: 'usa mcdonalds comida rapida hamburguesa cadena' },
  { nombre: 'McNuggets (10 unidades)', porcionDefault: '10 unidades', cal: 440, prot: 24, carb: 27, grasa: 27, unidad: 'porcion', tags: 'usa mcdonalds comida rapida pollo cadena' },
  { nombre: 'Papas fritas (porcion mediana)', porcionDefault: '1 porcion', cal: 340, prot: 4, carb: 44, grasa: 16, unidad: 'porcion', tags: 'comida rapida cadena guarnicion' },
  { nombre: 'Papas fritas (porcion grande)', porcionDefault: '1 porcion', cal: 510, prot: 7, carb: 67, grasa: 24, unidad: 'porcion', tags: 'comida rapida cadena guarnicion' },
  ...
  // Sandwiches y wraps
  { nombre: 'Sandwich pan integral con JyQ', porcionDefault: '1 unidad', cal: 320, prot: 22, carb: 32, grasa: 12, unidad: 'unidad', tags: 'sandwich snack desayuno merienda' },
  { nombre: 'Sandwich pan blanco con JyQ', porcionDefault: '1 unidad', cal: 340, prot: 20, carb: 38, grasa: 12, unidad: 'unidad', tags: 'sandwich snack desayuno merienda' },
  { nombre: 'Sandwich sin TACC con JyQ', porcionDefault: '1 unidad', cal: 290, prot: 20, carb: 28, grasa: 11, unidad: 'unidad', tags: 'sandwich sin tacc sin gluten celiaco' },
  { nombre: 'Sandwich pan integral con lomito y queso', porcionDefault: '1 unidad', cal: 380, prot: 32, carb: 30, grasa: 14, unidad: 'unidad', tags: 'sandwich proteico almuerzo' },
  { nombre: 'Sandwich pan blanco con lomito y queso', porcionDefault: '1 unidad', cal: 400, prot: 30, carb: 36, grasa: 14, unidad: 'unidad', tags: 'sandwich proteico almuerzo' },
  { nombre: 'Sandwich sin TACC con lomito y queso', porcionDefault: '1 unidad', cal: 360, prot: 30, carb: 26, grasa: 13, unidad: 'unidad', tags: 'sandwich sin tacc proteico' },
  { nombre: 'Sandwich pan integral con pollo y palta', porcionDefault: '1 unidad', cal: 380, prot: 28, carb: 30, grasa: 16, unidad: 'unidad', tags: 'sandwich proteico saludable' },
  { nombre: 'Sandwich pan integral con atun y mayonesa', porcionDefault: '1 unidad', cal: 360, prot: 24, carb: 30, grasa: 15, unidad: 'unidad', tags: 'sandwich proteico' },
  { nombre: 'Sandwich pan integral con huevo y queso', porcionDefault: '1 unidad', cal: 340, prot: 18, carb: 30, grasa: 16, unidad: 'unidad', tags: 'sandwich desayuno proteico' },
  { nombre: 'Sandwich pan integral vegetariano (queso y vegetales)', porcionDefault: '1 unidad', cal: 280, prot: 12, carb: 32, grasa: 11, unidad: 'unidad', tags: 'sandwich vegetariano' },
  { nombre: 'Sandwich vegano (palta, tomate, lechuga)', porcionDefault: '1 unidad', cal: 260, prot: 7, carb: 30, grasa: 12, unidad: 'unidad', tags: 'sandwich vegano' },
  { nombre: 'Sandwich pan arabe con falafel', porcionDefault: '1 unidad', cal: 380, prot: 14, carb: 48, grasa: 14, unidad: 'unidad', tags: 'sandwich vegano arabe' },
  { nombre: 'Sandwich tostado JyQ a la plancha', porcionDefault: '1 unidad', cal: 360, prot: 22, carb: 34, grasa: 14, unidad: 'unidad', tags: 'sandwich tostado' },
  { nombre: 'Sandwich club (pollo, panceta, huevo, lechuga)', porcionDefault: '1 unidad', cal: 480, prot: 32, carb: 38, grasa: 22, unidad: 'unidad', tags: 'sandwich proteico almuerzo' },
  { nombre: 'Sandwich miga JyQ (3 unidades)', porcionDefault: '3 triples', cal: 280, prot: 14, carb: 32, grasa: 11, unidad: 'porcion', tags: 'sandwich miga merienda' },
  { nombre: 'Sandwich miga vegetariano (3 unidades)', porcionDefault: '3 triples', cal: 240, prot: 9, carb: 32, grasa: 9, unidad: 'porcion', tags: 'sandwich miga vegetariano' },
  { nombre: 'Wrap integral de pollo y vegetales', porcionDefault: '1 unidad', cal: 340, prot: 24, carb: 32, grasa: 12, unidad: 'unidad', tags: 'wrap proteico saludable' },
  { nombre: 'Wrap integral con humus y vegetales', porcionDefault: '1 unidad', cal: 300, prot: 10, carb: 38, grasa: 11, unidad: 'unidad', tags: 'wrap vegetariano vegano' },
  { nombre: 'Wrap sin TACC con pollo', porcionDefault: '1 unidad', cal: 320, prot: 24, carb: 28, grasa: 12, unidad: 'unidad', tags: 'wrap sin tacc sin gluten proteico' },
  { nombre: 'Choripan (chorizo en pan)', porcionDefault: '1 unidad', cal: 480, prot: 18, carb: 38, grasa: 28, unidad: 'unidad', tags: 'sandwich argentino choripan' },
  { nombre: 'Pebete de jamon crudo y queso', porcionDefault: '1 unidad', cal: 360, prot: 22, carb: 32, grasa: 16, unidad: 'unidad', tags: 'sandwich pebete' },
  { nombre: 'Tostada con palta y huevo', porcionDefault: '2 unidades', cal: 340, prot: 16, carb: 28, grasa: 18, unidad: 'porcion', tags: 'tostada desayuno saludable' },
  { nombre: 'Tostada con palta, tomate y semillas', porcionDefault: '2 unidades', cal: 280, prot: 8, carb: 30, grasa: 15, unidad: 'porcion', tags: 'tostada vegano vegetariano' },
  { nombre: 'Tostada con queso crema y salmon', porcionDefault: '2 unidades', cal: 280, prot: 18, carb: 24, grasa: 12, unidad: 'porcion', tags: 'tostada proteico' },
  { nombre: 'Sandwich proteico (pan integral, pollo, queso, palta)', porcionDefault: '1 unidad', cal: 460, prot: 38, carb: 32, grasa: 20, unidad: 'unidad', tags: 'sandwich proteico alta proteina' },
