        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 max-w-2xl mx-auto">
            ...
            <div className="bg-dark-800 border border-dark-border rounded-2xl p-6 relative">
              ...
              <p className="text-4xl font-black text-white mb-1">$57.000<span className="text-white/30 text-sm font-normal">/ano</span></p>
              <p className="text-white/30 text-xs mb-6">Menos de $5.000/mes</p>
      ...
      <section className="py-20 px-4">
        <div className="max-w-2xl mx-auto">
          ...
          <div className="space-y-2">
            {[
              { q: 'Necesito experiencia para usar la app?', a: 'No. JustFit365 esta disenada tanto para principiantes como para avanzados. El sistema se adapta a tu nivel y objetivo.' },
